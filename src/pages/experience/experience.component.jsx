...
import L_ACCENTURE from "../../assets/img/experience/aziz.jpg";
          ...
          <Tilt options={{ max: 25 }}>
            <Card>
              ...
              <Card.Body className="d-flex justify-content-center flex-column">
                <div>
                  <Card.Title className="text-center">Front-End Developer</Card.Title>
                </div>
                <div>
                  <Card.Text className="text-center style">
                    ...
                    <ul className="text-left">
                      <li><strong>Create &amp; enhanced</strong> multiple features with customizability option across web application.</li>
                      <li><strong>Developed </strong> several project that contain backend function
                      </li>
